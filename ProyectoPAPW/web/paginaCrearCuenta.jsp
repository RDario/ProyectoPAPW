<%-- 
    Document   : paginaCrearCuenta
    Created on : 23/04/2016, 04:36:08 PM
    Author     : Dario
--%>
            ...
            <div id="page">
                <div id="page-bgtop">
                    <div id="page-bgbtm">
                        ...
                        <form id="formDatosPersonales" action="RegistrarUsuario" method="post" autocomplete="off">
                            <input name="nickname" type="text" id="lblNickname" placeholder="Nickname" autofocus="" required=""></p>
                                <input name="nombreUsuario" type="text" id="lblUsuario" placeholder="Nombre" autofocus="" required=""></p>
                                <input name="apellidosUsuario" type="text" id="lblApellidos" placeholder="Apellidos" autofocus="" required=""></p>
                                    <input name="email" type="text" id="lblemail" placeholder="E-mail" required=""></p>
                                        ...
                                        <label>Mes</label>
                                            <select name="listameses">
                                                <option selected value="-1"> Elige un mes</option>
                                        ...
                                        <label>Dìa</label>
                                            <select name="listadias">
                                                <option selected value="-1"> Elige un dìa</option>
...
<input name="domicilioCalle" type="text" id="lblCalle" placeholder="Calle y nùmero" autofocus="" required=""></p>
<input name="domicilioColonia" type="text" id="lblColonia" placeholder="Colonia" autofocus="" required=""></p>
<input name="codigopostal" type="text" id="lblCodigoPostal" placeholder="Codigo Postal" autofocus="" required=""></p>

<label>Paìs</label>
<select name="listapaises">
    <option value="0">Selecciona un paìs</option>
    <option value="1">Mèxico</option>
</select>
