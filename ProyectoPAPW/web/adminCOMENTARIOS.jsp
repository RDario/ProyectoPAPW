...
<!--AJAX de lOs COMENTARIOS -->
        <script>
            ...
            function recuperaResidenciaComnt(Texto)
            {
                ...
                ajaxComnt.open( "GET", ("admin_ComentariosAjax.jsp?texto=" + Texto), true );
...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_menu">
    	<div id="top_nav" class="ddsmoothmenu">
            <ul>
                ...
                <li><a href="adminCOMENTARIOS.jsp" class="selected">Comentarios</a></li>
                <%}%>
            </ul>
            <br style="clear: left" />
    ...
    <div id="templatemo_main">
        ...
        <div id="content" class="float_r">
            ...
            <form name="CateSub"  method="post">
                <br/>
                
                <input type="text" name="Texto" required="required" onchange="recuperaResidenciaComnt(document.all.Texto.value)" />
