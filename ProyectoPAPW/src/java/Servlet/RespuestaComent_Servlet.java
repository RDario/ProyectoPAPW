 ...
 * @author Arturo
 */
public class RespuestaComent_Servlet extends HttpServlet {
             ...
             throws ServletException, IOException 
    {
        ...
        {
            ComentarioDao.RespuestaComentario(idCom, Respuesta);
        }
        
       
        
        /*RequestDispatcher disp = getServletContext().getRequestDispatcher("/miCuentaPERFIL.jsp");*/
        RequestDispatcher disp = getServletContext().getRequestDispatcher("/miCuentaMENSAJES.jsp?Coment="+idProd);
